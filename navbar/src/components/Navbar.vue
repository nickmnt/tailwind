<template>
  <header class="bg-gray-900">
    ...
    <div :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-4">
      ...
      <a href="#" class="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1 mt-1">Trips</a>
      <a href="#" class="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1 mt-1">Messages</a>
    </div>
  </header>
</template>
