<template>
  <header class="bg-gray-900 sm:flex sm:justify-between sm:px-4 sm:py-3 sm:items-center">
    ...
    <div :class="isOpen ? 'block' : 'hidden'" class="px-2 pt-2 pb-4 sm:flex sm:p-0">
      <a href="#" class="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1">List your property</a>
      <a href="#" class="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1 mt-1 sm:mt-0 sm:ml-2">Trips</a>
      <a href="#" class="block text-white font-semibold hover:bg-gray-800 rounded px-2 py-1 mt-1 sm:mt-0 sm:ml-2">Messages</a>
    </div>
  </header>
</template>
