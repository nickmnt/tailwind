      ...
      <div class="bg-gray-100 flex">
        <div class="px-8 py-12 max-w-md mx-auto sm:max-w-xl lg:max-w-full lg:w-1/2 lg:py-24 lg:px-12">
          <div class="xl:max-w-lg xl:ml-auto">
            ...
            <img class="mt-6 rounded-lg shadow-xl sm:mt-8 sm:h72 sm:w-full sm:object-cover sm:object-center lg:hidden" src="/img/beach-work.jpg" alt="Woman workcationing on the beach">
      ...
      <div>
        <div class="max-w-md sm:max-w-xl lg:max-w-6xl mx-auto px-8 lg:px-12 py-8">
          ...
          <div class="flex flex-wrap -mx-4">
            <div class="mt-6 w-full px-4 lg:w-1/2 xl:w-1/3" v-for="(destination, index) in popularDestinations" :key="index">
