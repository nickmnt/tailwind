<template>
  <header class="bg-gray-900 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
    ...
    <nav :class="isOpen ? 'block' : 'hidden'" class="sm:block">
      ...
      <div class="sm:hidden px-4 py-5 relative border-t border-gray-800">
        <div class="flex items-center">
          <img class="h-8 w-8 border-2 border-gray-600 rounded-full object-cover" src="/img/avatar.avif"
            alt="Your avatar">
